    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <h1>Administrar centro medico</h1>
          </div>

          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="inicio">Inicio</a></li>
              <li class="breadcrumb-item active">Administar centro medico</li>
            </ol>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <table id="example2" class="table table-bordered table-hover table-striped tablas">
            ...
            <tbody>
              <?php
                $centros = ControladorCentroMedico::ctrMostrarCentroMedico();

                foreach($centros as $centro){
                  echo '<tr>';
                    echo '<td>'.$centro->getId().'</td>';
                    echo '<td>'.$centro->getNombre().'</td>';
                    echo '<td>'.$centro->getDepartamento().'</td>';
                    echo '<td>'.$centro->getTelefono().'</td>';
