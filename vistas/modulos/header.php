...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
      <a href="#" class="nav-link d-block" data-toggle="dropdown">
        <div class="user-panel pb-2 mr-2 d-flex">
          <div clas="image">
            <img src="vistas/dist/img/user2-160x160.jpg" class="img-circle elevation-2">
          </div>
          <div class="info">
            Jonathan Guillen
          </div>
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="salir" class="dropdown-item">
            <i class="fas fa-arrow-right-from-bracket mr-2"></i>Salir
